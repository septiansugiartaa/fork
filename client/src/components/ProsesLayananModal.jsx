      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="bg-blue-50 p-3 rounded-xl border border-blue-100 mb-2">
                <p className="text-xs text-blue-600 font-bold uppercase mb-1">Layanan</p>
            ...
            <div>
                ...
                <div className="relative">
                    <textarea 
                        rows="3"
                        className="w-full pl-9 p-2.5 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-blue-500 resize-none"
            ...
            <div className="pt-2 flex gap-3">
                ...
                <button type="submit" disabled={saving} className="flex-1 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 flex justify-center items-center font-medium transition disabled:opacity-70">
