...
// 1. TAMBAHKAN PROP userRole
export default function UstadzModal({
  isOpen,
  onClose,
  isEditing,
  editData,
  ...
  // Hanya pengurus dan admin yang bisa edit. Sisanya (termasuk pimpinan) read-only.
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (isReadOnly) return; // Proteksi tambahan
  ...
  // 3. Class bawaan untuk input agar berubah warna saat di-disable
      ...
      <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto">
          <form id="ustadzForm" onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  rows="2"
                  disabled={isReadOnly}
                  className={`pl-9 ${inputClassName} resize-none`}
            ...
            {/* Sembunyikan field password jika Read Only (Pimpinan tidak perlu lihat/ubah password ustadz) */}
            {!isReadOnly && (
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  {isEditing
