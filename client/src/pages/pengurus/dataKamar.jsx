  ...
  return (
    <div className="space-y-6 relative">
      ...
      <div className="flex justify-between items-center">
        ...
        <button onClick={() => setModalKamar({ isOpen: true, isEditing: false, data: null })} className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-xl font-medium flex items-center shadow-lg transition">
                                ...
                                <tr key={item.id} className="hover:bg-gray-50 transition">
                                    ...
                                    <td className="p-4 text-center">
                                        <div className="flex justify-center gap-2">
                                            <button onClick={() => setModalKamar({ isOpen: true, isEditing: true, data: item })} className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg"><Edit2 size={18}/></button>
                    ...
                    <div key={item.id} className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-col gap-3">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <span className={`inline-block mt-2 px-2 py-0.5 rounded text-xs font-bold ${item.gender === 'Laki_laki' ? 'bg-blue-100 text-blue-700' : 'bg-pink-100 text-pink-700'}`}>
                        ...
                        <div className="grid grid-cols-2 gap-3 mt-1">
                            <button onClick={() => setModalKamar({ isOpen: true, isEditing: true, data: item })} className="py-2 bg-blue-50 text-blue-600 rounded-xl font-semibold text-sm flex justify-center items-center gap-2"><Edit2 size={16}/> Edit</button>
