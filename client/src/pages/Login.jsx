...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Menggunakan instance api (tanpa URL lengkap karena sudah di-proxy)
  ...
  const handleKirimWA = (e) => {
    ...
    if (!forgotData.nama || !forgotData.nip)
      return alert("Nama dan NIS/NIP wajib diisi!");
          ...
          <div className="hidden lg:block mb-8">
            ...
            <p className="text-gray-500">
              {step === 1
                ...
                : "Sistem mendeteksi beberapa akses pada akun Anda"}
            </p>
          </div>
              ...
              <div className="grid gap-3">
                {availableRoles.map((role) => (
                  ...
                  >
                    ...
                    <svg
                      className="w-5 h-5 opacity-50 group-hover:opacity-100 transform group-hover:translate-x-1 transition-all"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <form onSubmit={handleKirimWA} className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setForgotData({ ...forgotData, nama: e.target.value })
                      }
                      autoFocus
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setForgotData({ ...forgotData, nip: e.target.value })
                      }
                    />
                  </div>
                  <div className="pt-4">
