...
export default function UstadzProfile() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-10 w-full overflow-x-hidden">
      ...
      {/* Toast Notification */}
      {message.text && (
        <div className={`fixed top-4 left-4 right-4 md:top-8 md:right-8 md:left-auto md:w-96 z-50 p-4 rounded-xl shadow-2xl flex items-center gap-3 animate-in fade-in duration-300 border-l-4 ${message.type === 'error' ? 'bg-white border-red-500 text-red-700' : 'bg-white border-green-500 text-green-700'}`}>
